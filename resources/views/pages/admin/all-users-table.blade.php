                            ...
                            <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-success waves-effect waves-light">Generate Referral</button></a>
                                    </td>
                                    ...
                                    <td>{{  \Carbon\Carbon::parse($user['email_verified_at'])->format('d F Y')  }}</td>

                                    @else

                                    <td>
                                        <a href="{{ route('admin.user-email-verify',['user'=>$user['id']]) }}">
                                        <button type="button" class="btn btn-success waves-effect waves-light">Verify Email</button></a>
                                    </td>
