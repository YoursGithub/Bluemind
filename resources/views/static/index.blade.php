...
<body>
    ...
    <div id="popup" style="display: none; position: fixed; top: 50%; left: 50%; transform: translate(-50%, -50%); max-width: 600px; width: 90%; z-index: 1000;">

        <div id="closeButton" style="position: absolute; top: 10px; right: 10px; background-color: rgba(70, 90, 120, 0.8); width: 30px; height: 30px; border-radius: 50%; display: flex; align-items: center; justify-content: center; cursor: pointer; z-index: 1001;">
    ...
    <div class="body_wrap">
        <!-- header start -->
        <header id="xb-header-area" class="header-area" style="z-index: 9999999;">
        ...
        <main>
            ...
            <section class="hero-section">
                ...
                <div class="content">
                    ...
                    <p class="description"> <span class="highlight">0%</span> Risk with <span class="highlight">100%</span> Security </br> Maximizing Your Returns Safely</p>
                    <div class="buttons">
            ...
            <section class="partners z-3 pt-135">
                ...
                <div class="partner-active partner-slider ul_li">
                    <div class="swiper-wrapper" style="margin-left: 20px;">
                        <div class="swiper-slide">
                            <div class="partner-card" style="width: 280px; height: 250px; border-radius: 12px; overflow: hidden; font-family: Arial, sans-serif; background: linear-gradient(135deg, #141b31 0%, #0a0e1a 100%); box-shadow: 0 8px 24px rgba(0,0,0,0.3); position: relative; display: flex; flex-direction: column; align-items: center; justify-content: center; transition: transform 0.3s ease, box-shadow 0.3s ease;" onmouseover="this.style.transform='translateY(-5px)'; this.style.boxShadow='0 12px 28px rgba(0,0,0,0.4)';" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 8px 24px rgba(0,0,0,0.3)';">
    
                                <div class="partner-logo" style="width: 100%; height: 120px; display: flex; justify-content: center; align-items: center; margin-bottom: 5px;">
                                  <img src="/assets/img/partner/Gateio.png" alt="Binance Logo" style="max-width: 120px; max-height: 100px; object-fit: contain;">
                                </div>
                                
                                <div class="partner-name" style="font-size: 20px; font-weight: bold; color: #ffffff; margin: 10px 0; text-align: center;">
                                  Binancioooo
                                </div>
                                
                                <div class="partner-info" style="font-size: 12px; color: #8a8d98; text-align: center; line-height: 1.4; width: 85%; margin-bottom: 10px;">
                                  <div style="margin-bottom: 5px; color: #00b4ff;">Leading Cryptocurrency Exchange</div>
                                  <div>One Binance Square, Financial District</div>
                                  <div>Singapore 049908</div>
                                </div>
                                
                                <div style="position: absolute; bottom: 0; left: 0; width: 100%; height: 3px; background: linear-gradient(90deg, #00b4ff, #2b6aff); opacity: 0.8;"></div>
                              </div>
                        </div>
                        ...
                        <div class="swiper-slide">
                            <div class="partner-card" style="width: 280px; height: 250px; border-radius: 12px; overflow: hidden; font-family: Arial, sans-serif; background: linear-gradient(135deg, #141b31 0%, #0a0e1a 100%); box-shadow: 0 8px 24px rgba(0,0,0,0.3); position: relative; display: flex; flex-direction: column; align-items: center; justify-content: center; transition: transform 0.3s ease, box-shadow 0.3s ease;" onmouseover="this.style.transform='translateY(-5px)'; this.style.boxShadow='0 12px 28px rgba(0,0,0,0.4)';" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 8px 24px rgba(0,0,0,0.3)';">
                                ...
                                <div class="partner-logo" style="width: 100%; height: 120px; display: flex; justify-content: center; align-items: center; margin-bottom: 5px;">
                                  <img src="/assets/img/partner/bybit.png" alt="Binance Logo" style="max-width: 120px; max-height: 100px; object-fit: contain;">
                                </div>
                                ...
                                <a href="/roadmap" class="xb-feature-link">
                                    <div class="xb-feature pos-rel">
                                        <div class="xb-item--holder text-center">
                                            ...
                                            <p class="xb-item--content">Launch a user-friendly copy trading platform for
                    ...
                    <div class="feature-crypto-wrap pt-125 pb-120">
                        ...
                        <div class="container">
                            <div class="section-title pb-55 text-center">
                                <h1 class="title">The best crypto based investment platform & we operate in stages</h1>
                            </div>
                                            ...
                                            <div class="col-lg-12 mb-30">
                                                <div class="xb-freatue-crypto bg_img ul_li "
                                                    ...
                                                    <div class="xb-item--holder">
                                                        ...
                                                        <p class="xb-item--content"> We are a secure investment platform
...
<!-- main area end  -->
<!-- footer strt -->
<footer class="footer bg_img pos-rel mt-145" data-background="assets/img/bg/footer-bg.png">
    <div class="container">
        <div class="xb-contact">
            <div class="row g-0 mt-none-30">
                <div class="col-lg-7 mt-30">
                    <div class="xb-inner bg_img mt-10" data-background="assets/img/bg/form_bg.png">
                ...
                <div class="col-lg-5 mt-40 pc-only">
    ...
    <div class="container">
        <div class="xb-footer-bottom">
            <div class="xb-footer-wrap ul_li_between">
                <div class="xb-item--footer_widget mb-30">
                    ...
                    <ul class="xb-item--footer_widget-list">
                        ...
                        <li><a target="_blank"
                                href="https://firebasestorage.googleapis.com/v0/b/blue-mind-global.appspot.com/o/Terms%20%26%20Conditions.pdf?alt=media&token=30d09536-fd1a-4650-aee3-6edb9bc90b20">Terms
                                & Conditions</a>
                        </li>
                    </ul>
                </div>
            ...
            <!-- <div class="footer-copyright text-center">
                Developed by <a target="_blank" href="https://www.linkedin.com/in/devjadiya/"> Dev Jadiya. </a> All
                rights reserved.
            </div> -->
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        featureCols.forEach(col => {
            ...
            col.addEventListener('mousemove', (e) => {
                ...
                const hoverDialogueX = x + offset + hoverRect.width > rect.width ? rect.width - hoverRect.width - offset : x + offset;
                const hoverDialogueY = y + offset + hoverRect.height > rect.height ? rect.height - hoverRect.height - offset : y + offset;
...
<!-- <script>
    ...
    document.addEventListener('keydown', function(e) {
      if (e.ctrlKey && (e.key === 'u' || e.key === 's' || e.key === 'a' || e.key === 'c' || e.key === 'i' || e.key === 'j')) {
        e.preventDefault();
      }
    });
  </script>
